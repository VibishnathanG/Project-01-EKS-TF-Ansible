...
resource "aws_subnet" "Mysubnet01" {
  ...
  cidr_block              = var.public_subnets1[1]
...
resource "aws_subnet" "Mysubnet02" {
  vpc_id                  = aws_vpc.myvpc.id
  cidr_block              = var.public_subnets2[1]
...
resource "aws_instance" "kubectl-server" {
  ami                         = "ami-0ba259e664698cbfc" # Replace with a valid AMI ID for ap-south-1 region
  key_name                    = "Basic_Mumbai_KP"       # Make sure the key pair exists in ap-south-1 region
